  ...
  <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <img class="h-8 w-auto" src="/storage/{{'logo.png'}}" alt="Your Company">
        </div>
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <a href="{{url("automovel")}}" class="text-gray-300 hover:bg-red-900 hover:text-white rounded-md px-3 py-2 text-sm no-underline" aria-current="page" >Comprar Carro</a>
            <a href="{{url("automovel/create")}}" class="text-gray-300 hover:bg-red-900 hover:text-white rounded-md px-3 py-2 text-sm font-medium no-underline" >Vender Carro</a>
            <a href="{{url("moto")}}" class="text-gray-300 hover:bg-red-900 hover:text-white rounded-md px-3 py-2 text-sm font-medium no-underline">Comprar Moto</a>
